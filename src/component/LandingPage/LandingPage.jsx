...
function LandingPage() {
  const [trueSpan, settrueSpan] = useState(680);
  const [falseSpan, setfalseSpan] = useState(7);
        ...
        <section className="code">
          <div className="like-dislike-container">
            <div className="tool-box">
              <button className="btn-close" onClick={() => setall(false)}>×</button>
            </div>
            ...
            <div className="icons-box">
              <div className="icons">
                <label className="btn-label" htmlFor="like-checkbox">
                  ...
                  <svg
                    onClick={() => settrueSpan(trueSpan + 1)}
                    className="svgs"
              ...
              <div className="icons">
                <label className="btn-label" htmlFor="dislike-checkbox">
                  ...
                  <svg
                    onClick={() => setfalseSpan(falseSpan + 1)}
                    className="svgs"
